 ...
 * multiple callbacks, each should be called in the order in which they were subscribed. An array of
 * results should be returned. You can assume no callbacks passed to subscribe are referentially identical.
 ...
 *
 * emit - This method takes in two arguments: the name of an event as a string and an optional array
 * of arguments that will be passed to the callback(s). If there are no callbacks subscribed to the
 * given event, return an empty array. Otherwise, return an array of the results of all callback calls
